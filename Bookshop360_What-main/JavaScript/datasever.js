...
loginButton.addEventListener('click', () => {
    if (isLoggedIn) {
        ...
        const email = localStorage.getItem('email'); // Assuming you store email as well
        const action = confirm(`Tên tài khoản: ${username}\n\nBạn có muốn đăng xuất (xoá tài khoản) không?`);
